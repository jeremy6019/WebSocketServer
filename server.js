/*node js 에 웹소켓 모듈 지원여부 확인 */
var WebSocket = require("ws");
var http =require("http");
var fs = require("fs"); //filesystem :원래 자바스크립크는 웹용이라서 
//로컬파일을 제어할 수 없으나 node.js 에서는 이게 가능하다 
...
server.on("connection",function(socket){
    ...
    socket.on("message",function(data){
        ...
        //클라이언트의 베시지를 다시보내자(echo)
        //모든 접속자를 대상으로 send를 호출한다 멀티캐스팅 
